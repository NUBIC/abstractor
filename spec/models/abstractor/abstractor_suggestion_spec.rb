...
describe  Abstractor::AbstractorSuggestion do
  ...
  it "can detect a suggestion from a suggested value" do
    ...
    abstractor_suggestion_source_bar = FactoryGirl.create(:abstractor_suggestion_source, abstractor_suggestion: abstractor_suggestion_bar, abstractor_abstraction_source: abstractor_abstraction_source, match_value: 'bar', source_id: 1, source_type: 'Foo')
