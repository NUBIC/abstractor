module Abstractor
  module Enum
    ...
    ABSTRACTION_STATUS_PARTIALLY_REVIEWED = 'partially reviewed'
    ABSTRACTION_STATUS_ACTUALLY_ANSWERED  = 'actually answered'
    ABSTRACTION_STATUSES = [ABSTRACTION_STATUS_NEEDS_REVIEW, ABSTRACTION_STATUS_REVIEWED, ABSTRACTION_STATUS_PARTIALLY_REVIEWED, ABSTRACTION_STATUS_ACTUALLY_ANSWERED]
